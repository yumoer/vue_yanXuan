    ...
    <div class="container">
      ...
      <div class="container_main">
        ...
        <div class="main_channels">
          <div class="channels_mode swiper-container" ref="channel">
            <ul class="mode_list swiper-wrapper" >
              <!-- 一个块 -->
              <li  class="list_item swiper-slide" v-for="(item,index) in shiwu.column" :key="index">
        ...
        <div class="main_tuijian">
          <div class="tuijian_content" >
            <div class="content_title">为你推荐</div>
            <a href="" class="content_top">
              <div class="top_image">
                <div class="image_icon">{{shiwu.recommendOne.nickname}}</div>
              </div>
              <div class="top_title">
                <div class="title_top">
              ...
              <div class="bottom_left">
                <div class="left_line1">
                  <div class="line_info">
                    ...
                    <div class="info_name">{{shiwu.recommendThree.nickname}}</div>
                  </div>
                </div>
                <div class="left_line2">
        ...
        <div class="main_tenfifteen">
          <div class="tenfifteen_wrap">
            ...
            <div class="wrap_info swiper-container">
              <ul class="wrap_list swiper-wrapper">
                <li  class="list_item swiper-slide" v-for="(item,index) in shiwu.tenfifteen" :key="index">
  ...
  export default {
    ...
    mounted(){
      this.$store.dispatch('getShiwu',()=>{
        this.$nextTick(()=>{
          new BSscroll(this.$refs.channelsMode,{
            click:true
          })
        })
      })

      new Swiper(this.$refs.channel,{
